...
export const TEAM_VISUAL_THEMES: Record<ProductionTeamCode, TeamVisualTheme> = {
  VBS: {
    ...
    accent: '#1050A0',
    accentBright: '#60A5FA',
    soft: 'rgba(16, 80, 160, 0.08)',
    border: 'rgba(16, 80, 160, 0.38)',
    shadow: 'rgba(16, 80, 160, 0.20)',
    onAccent: '#FFFFFF',
    emoji: '⚽',
  ...
  VGS: {
    ...
    accent: '#C1121F',
    accentBright: '#F87171',
    soft: 'rgba(193, 18, 31, 0.08)',
    border: 'rgba(193, 18, 31, 0.38)',
    shadow: 'rgba(193, 18, 31, 0.20)',
    onAccent: '#FFFFFF',
    emoji: '⚽',
