...
export const TEAM_CATALOG: readonly TeamCatalogEntry[] = [
  ...
  { id: 'basketball-smp-boys', sport: 'Basketball', division: 'SMP', gender: 'Boys', displayName: 'SMP Boys Basketball', shortName: 'SMP Boys', menuCode: 'SMPBB', note: 'Middle School', rosterTab: 'Basketball_SMP_Boys', production: true },
  { id: 'basketball-smp-girls', sport: 'Basketball', division: 'SMP', gender: 'Girls', displayName: 'SMP Girls Basketball', shortName: 'SMP Girls', menuCode: 'SMPGB', note: 'Middle School', rosterTab: 'Basketball_SMP_Girls', production: true },
