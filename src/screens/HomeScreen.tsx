  ...
  return (
    <div className="animate-in fade-in duration-500 pb-8 px-4 space-y-6 mt-4">
      ...
      <section className="space-y-3" aria-labelledby="at-a-glance-heading">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className="group flex min-h-[168px] min-w-0 flex-col rounded-3xl border border-brand-navy/10 bg-[linear-gradient(145deg,#FFFFFF_0%,rgba(248,250,252,0.94)_70%,rgba(102,155,188,0.16)_100%)] p-4 text-left shadow-[0_4px_12px_rgba(0,48,73,0.08)] transition-transform hover:-translate-y-0.5 dark:border-white/10 dark:bg-[linear-gradient(145deg,rgba(0,48,73,0.72),rgba(10,4,5,0.96))]"
          ...
          <button
            ...
            className="group flex min-h-[168px] min-w-0 flex-col rounded-3xl border border-brand-red/12 bg-[linear-gradient(145deg,#FFFFFF_0%,rgba(248,250,252,0.94)_66%,rgba(193,18,31,0.11)_100%)] p-4 text-left shadow-[0_4px_12px_rgba(120,0,0,0.08)] transition-transform hover:-translate-y-0.5 disabled:cursor-default disabled:hover:translate-y-0 dark:border-white/10 dark:bg-[linear-gradient(145deg,rgba(120,0,0,0.62),rgba(10,4,5,0.96))]"
      ...
      <button
        ...
        className="group flex w-full items-center gap-4 overflow-hidden rounded-3xl border border-brand-red/12 bg-[linear-gradient(120deg,#FFFFFF_0%,rgba(248,250,252,0.94)_58%,rgba(193,18,31,0.09)_100%)] p-4 text-left shadow-[0_3px_10px_rgba(120,0,0,0.06)] transition-transform hover:-translate-y-0.5 hover:border-brand-red/25 dark:border-white/10 dark:bg-[linear-gradient(120deg,rgba(120,0,0,0.54),rgba(10,4,5,0.96))]"
